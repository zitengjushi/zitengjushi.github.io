...
const _http = axios.create({
  ...
  baseURL: "https://py.doube.eu.org/v2/spider?site=9037cfae7c64405111e0e364401adb60", //替换成其他地址
});
...
const meta = {
  key: "pingguo", //key不能与其他site冲突
  name: "小苹果",
  type: 4,
  api: "/video/pingguo", //使用相对地址，服务会自动处理，不能与其他site冲突
  searchable: 1,
  quickSearch: 1,
  changeable: 1,
};
